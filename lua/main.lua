  ...
  conn:on("receive", function(conn, payload)
    ...
    if (method=='GET') then -- handling get request
      if (path=='/') then
        ...
        buf = buf..'<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/flofeurstein/esp_io/js/app.js"></script>'
        buf = buf..'<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/flofeurstein/esp_io/js/directives.js"></script>'
